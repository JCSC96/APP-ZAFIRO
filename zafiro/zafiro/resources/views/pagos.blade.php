...
<body>
    ...
    <h1 class="text-center p-3">Pagos</h1>
    ...
    <div class="p-5 table-responsive">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    <th>{{ $key->nombre }}</th>
                    <td>${{ $key->valor_pagado }}</td>
                    <td>{{ $key->fecha }}</td>
                    <td>
                        <a href="" data-bs-toggle="modal" data-bs-target="#ModalEditar{{ $key->id_usuarios }}"
                            class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="{{ route('crud.deletepagos', $key->id_pagos) }}" onclick="return res ()"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('crud.updatepagos') }}" method="POST">
                                        @csrf
                                        <div class="mb-3" >
                                            <label for="exampleInputEmail1" class="form-label">Modificar Pagos</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                name="txtnusuario" aria-describedby="emailHelp"
                                                value="{{$key->nombre }}" disabled>
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">Valor Pagado</label>
                                            <input type="text" class="form-control" id="exampleInputPassword1"
                                                name="txtvalorpagado" value="{{ $key->valor_pagado }}">
                                        </div>
                    ...
                    <div class="modal fade" id="ModalRegistrar" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('crud.createpagos') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                name="txtvalorpago" aria-describedby="emailHelp">
                                        </div>

                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Fecha</label>
                                            <input type="date" class="form-control" id="exampleInputEmail1"
                                                name="txtfechapago" aria-describedby="emailHelp"
                                                >
                                        </div>
